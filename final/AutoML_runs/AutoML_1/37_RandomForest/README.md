...
|           |    score |   threshold |
|:----------|---------:|------------:|
| logloss   | 0.163815 |  nan        |
| auc       | 0.98309  |  nan        |
| f1        | 0.929705 |    0.363047 |
| accuracy  | 0.929245 |    0.734732 |
| precision | 1        |    0.99728  |
| recall    | 1        |    0        |
| mcc       | 0.865021 |    0.734732 |


## Confusion matrix (at threshold=0.734732)
|                     |   Predicted as negative |   Predicted as positive |
|:--------------------|------------------------:|------------------------:|
| Labeled as negative |                     210 |                       2 |
| Labeled as positive |                      28 |                     184 |
