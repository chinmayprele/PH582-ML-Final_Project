...
|           |    score |   threshold |
|:----------|---------:|------------:|
| logloss   | 0.147845 |  nan        |
| auc       | 0.987852 |  nan        |
| f1        | 0.933333 |    0.363565 |
| accuracy  | 0.933962 |    0.676471 |
| precision | 1        |    0.870964 |
| recall    | 1        |    0        |
| mcc       | 0.871813 |    0.676471 |


## Confusion matrix (at threshold=0.676471)
|                     |   Predicted as negative |   Predicted as positive |
|:--------------------|------------------------:|------------------------:|
| Labeled as negative |                     208 |                       4 |
| Labeled as positive |                      24 |                     188 |
